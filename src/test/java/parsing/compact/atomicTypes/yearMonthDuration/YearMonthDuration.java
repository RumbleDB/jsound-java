...
public class YearMonthDuration extends BaseTest {
    static String filePath = "src/main/resources/compact/atomicTypes/yearMonthDuration/yearMonthDurationFile.json";
